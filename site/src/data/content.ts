...
export type Host = {
  ...
  slug: string;
  name: string;
  /** The studio or workshop name, shown under the host's name. */
  specialty: string;
...
const hostsCopy: Record<Lang, HostCopy[]> = {
  en: [
    { slug: 'qian', name: 'Qian', specialty: 'Clay Garden Pottery Studio',
    ...
    { slug: 'rebeca', name: 'Rebeca', specialty: 'Arte Gorda',
    ...
    { slug: 'nicole', name: 'Nicole', specialty: 'Anybody Can Whittle',
    ...
    { slug: 'celina', name: 'Celina', specialty: 'Gestaltwandel',
    ...
    { slug: 'evelyn', name: 'Evelyn Cseh', specialty: 'Tuka Creative Club',
    ...
    { slug: 'nina', name: 'Nina Kranz', specialty: 'Acrylic Painting',
    ...
    { slug: 'jem', name: 'Jem', specialty: 'Fischtal Foodlab',
    ...
    { slug: 'loom-lab', name: 'The Loom Lab', specialty: '3D Clay Printing',
    ...
    { slug: 'maximiliana', name: 'Maximiliana', specialty: 'Kunstraum Heartspace',
    ...
    { slug: 'pia', name: 'Pia', specialty: 'Rethink · Collective Painting',
    ...
    { slug: 'sarah', name: 'Sarah', specialty: 'Achtsamkeit & Kreativität',
    ...
    { slug: 'sabine', name: 'Sabine Alex', specialty: 'Mobile Dunkelkammer',
    ...
    { slug: 'faye', name: 'Faye', specialty: 'Senlë Studio',
    ...
    { slug: 'ana', name: 'Ana', specialty: 'Resonant Body',
  ...
  de: [
    ...
    { slug: 'nina', name: 'Nina Kranz', specialty: 'Acrylmalerei',
    ...
    { slug: 'loom-lab', name: 'The Loom Lab', specialty: '3D-Keramikdruck',
