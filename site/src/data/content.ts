...
const facets: Record<string, Pick<Host, 'activity' | 'groupRange' | 'hourRange' | 'groupPrice'>> = {
  ...
  evelyn:       { activity: 'craft',       groupRange: [1, 50],   hourRange: [3, 3], groupPrice: 59 },
  ...
  jem:          { activity: 'food',        groupRange: [1, 40],   hourRange: [3, 4], groupPrice: 55 },
  'loom-lab':   { activity: 'ceramics',    groupRange: [4, 6],    hourRange: [4, 4] },
  maximiliana:  { activity: 'art',         groupRange: [3, 12],   hourRange: [3, 3], groupPrice: 45 },
  ...
  // Eight is the studio's own limit, published on the Studio Blinkblink
  // workshops page — her own booking pages give no number.
...
const hostsCopyBase: Record<'en' | 'de', HostCopy[]> = {
  en: [
    ...
    { slug: 'jem', name: 'Jem', specialty: 'Sushi & kimchi making', studio: 'Fischtal Foodlab',
      ...
      group: '≤40 kimchi · ≤20 sushi', duration: '3–4 h', place: 'Fischtal Foodlab / your office', languages: 'EN · DE', priceNote: 'starting price' },
    ...
    { slug: 'maximiliana', name: 'Maximiliana', specialty: 'Bird sketching & watercolour', studio: 'Kunstraum Heartspace',
      ...
      group: '3–12', duration: '3 h', place: 'Kunstraum Heartspace, Berlin', languages: 'EN', priceNote: 'group discounts possible' },
    ...
    { slug: 'sabine', name: 'Sabine Alex', specialty: 'Analog photography & cyanotypes', studio: 'Mobile Dunkelkammer',
      ...
      group: 'Up to 12', duration: '4–5 h', place: 'On-site / BLO-Ateliers, Berlin', languages: 'DE · EN', priceNote: 'starting price' },
    ...
    // Copy from the-monk-garden.de; photos to follow.
    ...
    { slug: 'mijita', name: 'Mareen Ledebur', specialty: 'Jewellery smithing & wax carving', studio: 'Mijita',
      ...
      group: 'Up to 8', duration: '3–4 h', place: 'Studio Blinkblink, Gerichtstr. 25, Wedding', languages: 'DE' },
  ...
  de: [
    ...
    { slug: 'simone', name: 'Simone Klag', specialty: 'Steinbildhauerei in Alabaster', studio: 'B.L.O.-Ateliers',
      ...
      group: '3–6', duration: '4,5 Std. · 6 Std. · 2 × 4 Std.', place: 'B.L.O.-Ateliers, Kaskelstr. 55, Lichtenberg', languages: 'DE' },
    ...
    { slug: 'jem', name: 'Jem', specialty: 'Sushi & Kimchi', studio: 'Fischtal Foodlab',
      ...
      group: '≤40 Kimchi · ≤20 Sushi', duration: '3–4 Std.', place: 'Fischtal Foodlab / euer Büro', languages: 'EN · DE', priceNote: 'Einstiegspreis' },
    ...
    { slug: 'maximiliana', name: 'Maximiliana', specialty: 'Vogelskizzen & Aquarell', studio: 'Kunstraum Heartspace',
      ...
      group: '3–12', duration: '3 Std.', place: 'Kunstraum Heartspace, Berlin', languages: 'EN', priceNote: 'Gruppenrabatte möglich' },
    ...
    { slug: 'sabine', name: 'Sabine Alex', specialty: 'Analoge Fotografie & Cyanotypie', studio: 'Mobile Dunkelkammer',
      ...
      group: 'Bis 12', duration: '4–5 Std.', place: 'Vor Ort / BLO-Ateliers, Berlin', languages: 'DE · EN', priceNote: 'Einstiegspreis' },
    ...
    { slug: 'mijita', name: 'Mareen Ledebur', specialty: 'Schmuckschmieden & Wachsmodellieren', studio: 'Mijita',
      ...
      group: 'Bis 8', duration: '3–4 Std.', place: 'Studio Blinkblink, Gerichtstr. 25, Wedding', languages: 'DE' },
